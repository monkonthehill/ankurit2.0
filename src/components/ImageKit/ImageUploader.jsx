...
const ImageUploader = ({ 
  ...
  const AUTH_ENDPOINT = 'https://imagekit-auth-server-ib8y.onrender.com/auth';
  const PUBLIC_KEY = 'public_3Pd8+8b9G0fq9ZWATOe4pmquWyI=';
  const URL_ENDPOINT = 'https://ik.imagekit.io/ankurit';
